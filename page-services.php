...
<div class="content">
    ...
    <p>My process is rooted in the belief that design should be easy to consume and delightful to read online, interact with at an event or receive in the mail.</p>
</div> 
...
<div class="faq">
    ...
    <div class="content">
        ...
        <p>My list of services is meant to provide a general idea of my capabilities, but the packages I offer are customized for every client’s individual needs.</p>

        <p>No matter the project, I like to start by learning more about you, your goals and design needs. Then I  create several package options. After you select which package best meets your needs, I require a 25% deposit before starting a project.</p> 

        <h3>I’m not entirely sure what I need, but I have a general idea. What should I do?</h3>
        <p>Email is the best way to reach me. Send questions or just a hello to emmagrdina@gmail.com.</p>
        ...
        <p>Every project has a varied timeline. Some factors include but are not limited to what you need, when you need it by and what other projects I'm working on.</p>
